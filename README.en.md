...
[简体中文](README.md) · [Docs site](https://wenxuanzhang1209-cyber.github.io/jkinco-listen-open/) · [Architecture](docs/ARCHITECTURE.md) · [Model guide](docs/LOCAL_MODELS.md) · [Roadmap](docs/ROADMAP.md)
...
Hardware and quantization guidance: [docs/LOCAL_MODELS.md](docs/LOCAL_MODELS.md).
...
Module boundaries, data flow, and the security perimeter: [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md).
